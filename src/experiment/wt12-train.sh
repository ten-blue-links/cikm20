...
LOGP="${RESULTD}/wt12/log"
SCOREP="${RESULTD}/wt12/score"
RUNP="${RESULTD}/wt12/run"
EVALP="${RESULTD}/wt12/eval"
CACHEP="${SCRATCHD}/.cache"
QRELSF=${DATASETD}/12.val.qrel

mkdir -p $LOGP $MODELP $SCOREP $RUNP $EVALP

tr=$DATASETD/12.train.svm
v=$DATASETD/12.val.svm
